...
export const assistantCorpus = {
  ...
  entries: [
    ...
    },
    {
      ...
      keywords: ["enterprise ai interface", "enterprise ai ux", "product design", "design system", "provenance", "calibrated confidence", "permissions", "approval", "observable trace", "failure recovery", "empty state", "human in the loop", "human-in-the-loop", "ai trust", "operator workflow", "figma-level"],
