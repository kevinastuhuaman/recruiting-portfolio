...
export const routes = [
  ...
  { path: "/llms-full.txt", state: "fetch", title: "Full text profile", modified: "2026-07-14" },
  { path: "/profile.json", state: "fetch", title: "Structured profile", modified: "2026-07-14" },
  { path: "/projects.json", state: "fetch", title: "Structured projects", modified: "2026-07-14" },
  { path: "/resume.md", state: "fetch", title: "Markdown resume", modified: "2026-07-14" },
  { path: "/proof.json", state: "fetch", title: "Public evidence registry", modified: "2026-07-14" },
  { path: "/assistant-corpus.json", state: "fetch", title: "Public assistant corpus", modified: "2026-07-14" },
